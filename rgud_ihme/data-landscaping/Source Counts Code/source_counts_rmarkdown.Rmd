...
```{r echo = FALSE}
table1 <- data.table(location_id =c(523, 524, 560, 570, 101),location_name = c('Alaska', 'Alabama', 'Oregon', 'Washington', 'Canada'), country = c('United State of America','United State of America', 'United State of America', 'United State of America', 'Canada'), region_name = c('High-income North America', 'High-income North America', 'High-income North America', 'High-income North America', 'High-income North America'), year_start = c(2010, 2010, 2010, 2010, 2010), year_end = c(2011, 2011, 2011, 2011, 2011))
knitr::kable(table1, format = "markdown")
table2 <- data.table(location_id =c(523, 524, 560, 570, 101),location_name = c('Alaska', 'Alabama','Oregon', 'Washington', 'Canada'), country = c('United State of America','United State of America', 'United State of America', 'United State of America', 'Canada'), region_name = c('High-income North America', 'High-income North America', 'High-income North America', 'High-income North America', 'High-income North America'), year_start = c(2010, 2015, 2021, 2020, 2023), year_end = c(2011, 2016, 2021, 2020, 2023))
