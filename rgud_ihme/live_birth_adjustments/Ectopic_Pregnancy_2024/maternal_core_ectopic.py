...
##################
class Ectopic(Base):
    def __init__(self, cluster_dir, year_id, input_me, output_me, uncomplicated_seq_me, complicated_inc_seq_me,
                    complicated_acute_prev_seq_me, complicated_subacute_prev_seq_me, release_id):
        Base.__init__(self, cluster_dir, year_id, input_me, output_me, release_id)
        self.control_seq_me = uncomplicated_seq_me
        self.mild_seq_me = complicated_inc_seq_me
        self.mod_seq_me = complicated_acute_prev_seq_me
        self.sev_seq_me = complicated_subacute_prev_seq_me
...
if __name__ == "__main__":
    ...
    if class_name == "Ectopic":
        ...
        output_me, uncomplicated_seq_me, complicated_inc_seq_me, complicated_acute_prev_seq_me, complicated_subacute_prev_seq_me = (int(out_mes[0]), int(out_mes[1]), int(out_mes[2]), int(out_mes[3]), int(out_mes[4]))
        model = Ectopic(cluster_dir, year, input_me, output_me, uncomplicated_seq_me, complicated_inc_seq_me, complicated_acute_prev_seq_me, complicated_subacute_prev_seq_me, release_id)
