...
print(description)
if (me_id == 3620) | (me_id == 3629) | (me_id == 28984):
    measids = 6
elif (me_id == 28986) | (me_id == 28985):
    measids = 5
else:
    measids = [5,6]
...
dep_map = pd.read_csv('{}/dependency_map_ectopic.csv'.format(os.getcwd())) #Change as needed ######################################
...
epi_ids = pd.read_csv('{}/epi_ids_ectopic.csv'.format(os.getcwd())) #Change as needed #############################################
#print(epi_ids)
