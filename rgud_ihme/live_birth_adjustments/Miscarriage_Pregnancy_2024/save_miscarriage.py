...
print(description)
if (me_id == 3620) | (me_id == 3629) | (me_id == 28393) | (me_id == 28984) | (me_id == 32530):
    measids = 6
elif (me_id == 28986) | (me_id == 28985) | (me_id == 32531) | (me_id == 32532):
    measids = 5
else:
    measids = [5,6]
...
dep_map = pd.read_csv('{}/dependency_map_miscarriage.csv'.format(os.getcwd())) #Change as needed ######################################
...
epi_ids = pd.read_csv('{}/epi_ids_miscarriage.csv'.format(os.getcwd())) #Change as needed #############################################
#print(epi_ids)
