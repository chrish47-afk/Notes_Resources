...
if __name__ == "__main__":
    ...
    if class_name == "Miscarriage":
        ...
        model = Miscarriage(cluster_dir, year, input_me, output_me, uncomplicated_seq_me, complicated_inc_seq_me, complicated_acute_prev_seq_me, complicated_subacute_prev_seq_me, release_id)
