...
release_id = 16 #GBD 2022 results ###### Change as needed
...
dep_map = pd.read_csv('{}/dependency_map_ppcm.csv'.format(os.getcwd())) ###### Change as needed. ######################################
...
epi_ids = pd.read_csv('{}/epi_ids_ppcm.csv'.format(os.getcwd())) ###### Change as needed. #############################################
#print(epi_ids)
