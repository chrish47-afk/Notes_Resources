...
release_id = 16 #GBD 2022 results
...
dep_map = pd.read_csv('{}/dependency_map.csv'.format(os.getcwd())) #Change as needed ######################################
######################################
...
epi_ids = pd.read_csv('{}/epi_ids.csv'.format(os.getcwd())) #Change as needed #############################################
#print(epi_ids)
