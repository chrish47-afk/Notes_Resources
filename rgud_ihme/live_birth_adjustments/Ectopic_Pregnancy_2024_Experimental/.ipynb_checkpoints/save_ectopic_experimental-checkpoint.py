...
print(description)
if (me_id == 3620) | (me_id == 3629) | (me_id == 28393) | (me_id == 28984) | (me_id == 28983):
    measids = 6
elif (me_id == 28986) | (me_id == 28985) | (me_id == 32537) | (me_id == 32539) | (me_id == 32538) | (me_id == 32540):
    measids = 5
else:
    measids = [5,6]
...
dep_map = pd.read_csv('{}/dependency_map_ectopic_exp.csv'.format(os.getcwd())) #Change as needed ######################################
...
epi_ids = pd.read_csv('{}/epi_ids_ectopic_exp.csv'.format(os.getcwd())) #Change as needed #############################################
#print(epi_ids)
...
release_id = 33 #GBD 2023 Additional Publications
